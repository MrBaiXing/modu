<template>
	<view class="content">
		...
		<view class="facxiala">
			<dropdown-screen @finish="customClick" :itemArr='itemArr' :listArr='listArr' :linkageArr='linkageArr'>
			</dropdown-screen>
		</view>
		<view style="margin-top: 200rpx;">

		</view>
		<view class="fac_body" v-for="(v,i) in faclist" :key="i" @click="navigter(v)">
